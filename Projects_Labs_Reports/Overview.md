...
<blockquote><p>This lab was originally intended to be proof of concept for T1 SOC Analyst skills, thus I wasn't too worried about a secure network design. However, the Security/Blue Team/Cautious instincts in me are screaming to put in the extra time and work to implement a 5th VM -- a pfSense firewall to isolate the SIEM infrastructure on a dedicated management subnet. Endpoint-to-SIEM communications will now be restricted by stateful firewall policy to required Wazuh services.</p></blockquote>  
